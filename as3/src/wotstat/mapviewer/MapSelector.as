package wotstat.mapviewer {
  ...
  public class MapSelector extends AbstractWindowView {
    ...
    private function onStart(event:ButtonEvent):void {
      startViewing();
    }
    ...
    private function onClose(event:ButtonEvent):void {
      onWindowCloseS();
    }
