    ...
    override protected function populateData(items:Array):void {
      ...
      for (var i:int = 0; i < _renderers.length; ++i) {
        ...
        if (!badge) {
          ...
          badge.embedFonts = true;
          badge.selectable = badge.mouseEnabled = false;
          renderer.addChild(badge);
        }
        badge.visible = true;
        badge.text = eventsLabel;
        badge.scaleX = badge.scaleY = 1;
        badge.width = badge.textWidth + 5;
        badge.height = 20;
        badge.scaleX = 1 / renderer.scaleX;
        badge.scaleY = 1 / renderer.scaleY;
