package wotstat.mapviewer {
  ...
  public class BattleBridge extends AbstractView {
    ...
    private function buildControls():void {
      ...
      title = makeLabel(20, 0xE9E2BF);
      title.y = 18;
      mode = makeLabel(13, 0xC9C9B6);
      mode.y = 46;
    ...
    private function onBack(event:ButtonEvent):void {
      returnToHangar();
    }

    private function focusPanel():void {
      setFocus(this);
    }
    ...
    private function onInputLost(event:Event):void {
      inputLost();
    }
